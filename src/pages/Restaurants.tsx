...
const Restaurants = () => {
  const { user } = useAuth();
  const { restaurants, loading, refetch } = useUserRestaurants();
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-medium text-foreground">Mis Restaurantes</h1>
          <p className="text-sm text-muted-foreground">Gestiona tus locales asignados</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader className="pb-4">
          <CardTitle className="text-lg">Restaurantes asignados ({restaurants.length})</CardTitle>
        </CardHeader>
